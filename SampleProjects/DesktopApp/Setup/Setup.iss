...
#define MyAppName "Sample Desktop App"
#define MyAppExeName "SampleDesktopApp.exe"
...
AppId={{8BE12E17-ACEB-47A4-9D7E-88624E40DF1B}
AppName={#MyAppName}
...
Source: "..\Bin\SampleClassLibrary.dll"; DestDir: "{app}"; Flags: ignoreversion
